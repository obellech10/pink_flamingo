...
RSpec.describe 'As a user' do
  describe 'When I visit my profile page' do
    it "I can click on events in your neighborhood and I'm taken to event index page" do
      ...
      event_1 = user.events.create!(title: "Football Watch Party", date: "9-13-19", time: "8:00pm", address: "123 Main St", food: true, booze: true, radius: 0.25)
      event_2 = user.events.create!(title: "Book Club", date: "10-13-19", time: "8:00pm", address: "123 Main St", food: false, booze: false, radius: 1.0)
      event_3 = user.events.create!(title: "Poker Night", date: "11-13-19", time: "8:00pm", address: "123 Main St", food: false, booze: true, radius: 1.0)
